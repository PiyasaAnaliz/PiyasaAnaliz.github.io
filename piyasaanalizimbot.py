...
# Önbellek Verileri (Başlangıçta boş)
cache_data = {
...
def get_main_keyboard():
    # Butonlar burada tanımlanır. İstediğiniz isimleri buraya yazabilirsiniz.
    keyboard = [
...
async def send_category(update: Update, category: str, edit: bool = False):
    ...
    # Eğer butona basıldıysa mesajı düzenle, yoksa yeni mesaj gönder
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Start komutu geldiğinde doğrudan ana menüyü gönderir."""
    await update.message.reply_text(
...
def main():
    ...
    # Zamanlayıcı başlat (30 dakikada bir güncelle)
